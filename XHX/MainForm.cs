...
namespace XHX
{
    public partial class MainForm : XtraForm
    {
        ...
        void CreateBizMenuList()
        {
            ...
            subMenu = new ToolStripMenuItem("统计", null, new EventHandler(menu_Click)); subMenu.Tag = "StandardRate";
            mainMenu.DropDownItems.Add(subMenu);
            subMenu = new ToolStripMenuItem("检查标准结果查询", null, new EventHandler(menu_Click)); subMenu.Tag = "InspectionStandardSearch";
            mainMenu.DropDownItems.Add(subMenu);
            subMenu = new ToolStripMenuItem("失分描述查询", null, new EventHandler(menu_Click)); subMenu.Tag = "LossResultSearch";
            mainMenu.DropDownItems.Add(subMenu);
            subMenu = new ToolStripMenuItem("错误分数查询", null, new EventHandler(menu_Click)); subMenu.Tag = "ErrorScoreListSearch";
            mainMenu.DropDownItems.Add(subMenu);
            subMenu = new ToolStripMenuItem("Pad上传时间查询", null, new EventHandler(menu_Click)); subMenu.Tag = "PadUploadDateSearch";
            mainMenu.DropDownItems.Add(subMenu);
            ...
            //mainMenu.DropDownItems.Add(subMenu);
            subMenu = new ToolStripMenuItem("修改记录查询", null, new EventHandler(menu_Click)); subMenu.Tag = "AnswerScoreLog";
            mainMenu.DropDownItems.Add(subMenu);
        ...
        void menu_Click(object sender, EventArgs e)
        {
            ...
            Assembly asmb = Assembly.Load("ChangAn");
            ...
            if (name == "流程演练")
            {
                pageControl.Tag = "流程演练";

            }
            else if (name == "人员和单据")
            {
                pageControl.Tag = "人员和单据";
            }
            else if (name == "硬件")
            {
                pageControl.Tag = "硬件";
